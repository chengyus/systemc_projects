...
//2025/04/24 NOTE: SystemC 3.02 compile gave deprecation warning about SC_HAS_PROCESS.
...
//changing it with IEEE 1666-2023 update slids on p18
SC_MODULE(MODULE_C) { // pass additional input argument(s)
  ...
  void func_c() { // define function
    std::cout << name() << ", additional input argument i: " << i << std::endl;
  }
};
